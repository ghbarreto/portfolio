...
export const timelineHorizontal = [
    {
        ...
        date: '2019',
        image: lugaroLogo,
        description: 'Developed wireframes, site maps and content inventories for new website designs',
    },
    {
        ...
        date: '2021',
        image: MH,
        description: 'Implemented inumerous pages included the store and career pages.',
    },
    {
        title: 'Full-stack Dev',
        company: 'Kyte',
...
export const projects = [
    {
        name: 'FFXIV-Info',
        description: 'An app developed by me to help people know various features about the game Final Fantasy.',
    ...
    {
        name: 'covid-api',
        description: 'An app developed by me to help people track covid growth in countries around the world.',
    ...
    },
    {
        ...
        description: 'An app for a company that sells gas in Brazil, it helps automating stock management.',
        githubLink: 'https://github.com/ghbarreto/gas-project',
        live: null,
        date: 'Aug, 2021',
        images: ['/assets/images/gas-company/pedidos.png', '/assets/images/gas-company/product.png'],
    ...
    {
        name: 'my-portfolio',
        description: 'Used to be my potfolio. Developed using Node.JS, MongoDB, and EJS for the front-end.',
    ...
    {
        name: 'Multiple App',
        description: 'An app that I developed that has a lot of small features like weather-app, fizzbuzz, to-do list.',
...
export const jobExperience = {
    kyte: {
        ...
        date: 'Current',
        experience: 'Worked with the MERN stack to create webpages and landing pages for the Kyte App.',
    },
    MH: {
        title: 'Full Stack Developer',
        date: 'Current',

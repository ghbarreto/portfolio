        ...
        return _.map(timelineHorizontal, (e, index) => {
            ...
            return (
                <div key={index} className="mobile-container">
                    ...
                    <div className={`mobile-border mobile-border-${index} mobile-border-left-${index}`}></div>
                    <div className={`mobile-arrow mobile-arrow-${index} ${arrows} arrow-left-${index}`}></div>
                    ...
                    <div className={`mobile-paragraph mobile-paragraph-${index}`}>{e.description}</div>
                </div>
            );
        });
    };

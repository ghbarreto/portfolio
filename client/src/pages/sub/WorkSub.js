        ...
        return _.map(projects, (e, count) => {
            ...
            return (
                <React.Fragment key={count}>
                    <Animate
                        anim={odd}
                        className={`${decideBackgroundColor(count)} projects-list-item project-desktop`}
                    >
                        <div key={count}>
                            <div className="projects-list-item-name">
                                <span className="bracket-color bracket-format">{tags.closingOpening}</span>
                                {e.name}
    ...
    const displayProjectTitle = () => {
        return (
            <Animate anim={'Opacity'}>
                <span className="closing-opening-tags">{tags.closingOpening}</span> {projectTitle[0]}
            </Animate>
        );
    };

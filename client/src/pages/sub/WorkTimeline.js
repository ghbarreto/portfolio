...
import { timelineHorizontal, projectTitle, tags } from '../../utils/utils.functions';

const WorkTimeline = () => {
    const displayProjectTitle = () => {
        return (
            <div>
                <span className="closing-opening-tags">{tags.closingOpening}</span> {projectTitle[1]}
            </div>
        );
    };
            ...
            return (
                <div key={count} className={`horizontal-container-${count}`}>
                    ...
                    <div className="container-items">
                        ...
                        <div className="container-items-description description-format">{e.description}</div>
                    </div>

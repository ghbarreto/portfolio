...
import { BsGithub, BsLinkedin, BsFillCaretRightFill, BsCaretLeftFill } from 'react-icons/bs';
...
const Icons = ({ icon, styles, className, sizes, bold, ...props }) => {
    ...
    return (
        <>
            <IconContext.Provider value={{ className: [className], style: styles, size: sizes }}>
                {displayIcons()}

...
const ReactModal = ({ isOpen, closeModal, onRequestClose, carouselValues, ...props }) => {
    ...
    const setLightBox = e => {
        return <Lightbox images={e} open={true} setDisplayLightBoxFalse={setDisplayLightBoxFalse} />;
    };
    ...
    const displayHeader = () => {
        ...
        return (
            <div className="modal-header" key={imageRender}>
                ...
                >
                    {imageRender.length > 1 ? '* click image to expand' : '* still working on images'}
                </div>
                ...
                <div className="modal-header-paragraph">
                    ...
                    >
                        * Please note, these web apps are hosted on Heroku, so they might take a few seconds to
                        initialize once you open them.
                    </span>
                </div>
                ...
                <div className="modal-header-buttons">
                    ...
                    <Button
                        ...
                        styles={{
                            backgroundColor: !carouselValues.livePreview ? '#c2bebe' : '#ffe881',
                        ...
                        icon={
                            <Icons
                                icon={!carouselValues.livePreview ? 'no-live-preview' : 'live-preview'}
                                sizes={25}
        ...
        <animated.div style={modalStyle}>
            ...
            >
                <animated.div style={modalStyle}>
                    ...
                    {carouselValues.description || carouselValues.name ? displayHeader() : ''}
                </animated.div>
            </Modal>
        </animated.div>
    );
